...
app.prepare().then(() => {
    ...
    server.use("/general", restrictAccess);
    server.use("/sales", restrictAccess);
    server.use("/purchases", restrictAccess);
    server.use("/finances", restrictAccess);
    server.use("/logistics", restrictAccess);
